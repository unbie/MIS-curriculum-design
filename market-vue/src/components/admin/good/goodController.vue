<template>
  <div>
    ...
    <el-table :data="this.goodPropertyListShow" :border="true" ref="messageTable" height="500">
      ...
      <el-table-column prop="expressPrice" label="邮费"></el-table-column>
    ...
    <el-dialog :visible="dialogVisible" title="新增/编辑商品信息" @close="closeDialog">
      <el-form ref="editForm" :model="editForm" label-width="100px"  class="config-form" :rules="rules">
        ...
        <el-form-item label="邮费">
          <el-input v-model="editForm.expressPrice" name="expressPrice"></el-input>
        </el-form-item>
